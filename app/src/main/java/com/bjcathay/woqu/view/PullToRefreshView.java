...
public class PullToRefreshView extends LinearLayout {
	...
	private static final int PULL_DOWN_END = 5;
	private static final int PULL_DOWN_SRART = 6;
	/**
	 * last y
	 */
...
//				.findViewById(R.id.pull_to_load_image);
	...
	public void setFooteINVisible(boolean flag){
		if(flag){
	...
	public void setIsLoadFull(boolean isLoadFull) {
